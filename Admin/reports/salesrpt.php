...
<?php include_once "salesrptinfo.php" ?>
<?php
...
$sales_rpt = NULL; // Initialize page object first

class crsales_rpt extends crsales {
	...
	function __construct() {
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fsalesrpt";
...
//		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fsalesrpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fsalesrpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fsalesrpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($sales_rpt)) $sales_rpt = new crsales_rpt();
...
// Create page object
var sales_rpt = new ewr_Page("sales_rpt");

// Page properties
sales_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = sales_rpt.PageID;
</script>
<?php } ?>
...
<!-- Report grid (begin) -->
<?php if ($Page->Export <> "pdf") { ?>
<div id="gmp_sales" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="productname"><div class="sales_productname"><span class="ewTableHeaderCaption"><?php echo $Page->productname->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="productname">
<?php if ($Page->SortUrl($Page->productname) == "") { ?>
		<div class="ewTableHeaderBtn sales_productname">
			<span class="ewTableHeaderCaption"><?php echo $Page->productname->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer sales_productname" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->productname) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->productname->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="quantity"><div class="sales_quantity"><span class="ewTableHeaderCaption"><?php echo $Page->quantity->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="quantity">
<?php if ($Page->SortUrl($Page->quantity) == "") { ?>
		<div class="ewTableHeaderBtn sales_quantity">
			<span class="ewTableHeaderCaption"><?php echo $Page->quantity->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer sales_quantity" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->quantity) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->quantity->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="description"><div class="sales_description"><span class="ewTableHeaderCaption"><?php echo $Page->description->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="description">
<?php if ($Page->SortUrl($Page->description) == "") { ?>
		<div class="ewTableHeaderBtn sales_description">
			<span class="ewTableHeaderCaption"><?php echo $Page->description->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer sales_description" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->description) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->description->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="price"><div class="sales_price"><span class="ewTableHeaderCaption"><?php echo $Page->price->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="price">
<?php if ($Page->SortUrl($Page->price) == "") { ?>
		<div class="ewTableHeaderBtn sales_price">
			<span class="ewTableHeaderCaption"><?php echo $Page->price->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer sales_price" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->price) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->price->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="size"><div class="sales_size"><span class="ewTableHeaderCaption"><?php echo $Page->size->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="size">
<?php if ($Page->SortUrl($Page->size) == "") { ?>
		<div class="ewTableHeaderBtn sales_size">
			<span class="ewTableHeaderCaption"><?php echo $Page->size->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer sales_size" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->size) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->size->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="quantity1"><div class="sales_quantity1"><span class="ewTableHeaderCaption"><?php echo $Page->quantity1->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="quantity1">
<?php if ($Page->SortUrl($Page->quantity1) == "") { ?>
		<div class="ewTableHeaderBtn sales_quantity1">
			<span class="ewTableHeaderCaption"><?php echo $Page->quantity1->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer sales_quantity1" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->quantity1) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->quantity1->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="total_amount"><div class="sales_total_amount"><span class="ewTableHeaderCaption"><?php echo $Page->total_amount->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="total_amount">
<?php if ($Page->SortUrl($Page->total_amount) == "") { ?>
		<div class="ewTableHeaderBtn sales_total_amount">
			<span class="ewTableHeaderCaption"><?php echo $Page->total_amount->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer sales_total_amount" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->total_amount) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->total_amount->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="order_date"><div class="sales_order_date"><span class="ewTableHeaderCaption"><?php echo $Page->order_date->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="order_date">
<?php if ($Page->SortUrl($Page->order_date) == "") { ?>
		<div class="ewTableHeaderBtn sales_order_date">
			<span class="ewTableHeaderCaption"><?php echo $Page->order_date->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer sales_order_date" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->order_date) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->order_date->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="fname"><div class="sales_fname"><span class="ewTableHeaderCaption"><?php echo $Page->fname->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="fname">
<?php if ($Page->SortUrl($Page->fname) == "") { ?>
		<div class="ewTableHeaderBtn sales_fname">
			<span class="ewTableHeaderCaption"><?php echo $Page->fname->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer sales_fname" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->fname) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->fname->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="lname"><div class="sales_lname"><span class="ewTableHeaderCaption"><?php echo $Page->lname->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="lname">
<?php if ($Page->SortUrl($Page->lname) == "") { ?>
		<div class="ewTableHeaderBtn sales_lname">
			<span class="ewTableHeaderCaption"><?php echo $Page->lname->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer sales_lname" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->lname) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->lname->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="address"><div class="sales_address"><span class="ewTableHeaderCaption"><?php echo $Page->address->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="address">
<?php if ($Page->SortUrl($Page->address) == "") { ?>
		<div class="ewTableHeaderBtn sales_address">
			<span class="ewTableHeaderCaption"><?php echo $Page->address->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer sales_address" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->address) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->address->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="gender"><div class="sales_gender"><span class="ewTableHeaderCaption"><?php echo $Page->gender->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="gender">
<?php if ($Page->SortUrl($Page->gender) == "") { ?>
		<div class="ewTableHeaderBtn sales_gender">
			<span class="ewTableHeaderCaption"><?php echo $Page->gender->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer sales_gender" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->gender) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->gender->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="phn"><div class="sales_phn"><span class="ewTableHeaderCaption"><?php echo $Page->phn->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="phn">
<?php if ($Page->SortUrl($Page->phn) == "") { ?>
		<div class="ewTableHeaderBtn sales_phn">
			<span class="ewTableHeaderCaption"><?php echo $Page->phn->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer sales_phn" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->phn) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->phn->FldCaption() ?></span>
