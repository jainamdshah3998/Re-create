...
define("EWR_PROJECT_ID", "{33A3569A-8948-455F-A859-CDA3299C9672}", TRUE); // Project ID
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "recreate", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'EbzSDMXMjlkaqJUq', TRUE); // Random key for encryption
